        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8 animate-fade-in-left">
            ...
            <div className="flex items-center space-x-4 text-gray-600">
              ...
              <span>
                Farmgate Road, Dhaka, Bangladesh
              </span>
            </div>
            <div className="flex items-center space-x-4 text-gray-600">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in-right">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full py-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm animate-input"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm animate-input"
              ></textarea>
            </div>
            <div>
              <button
                type="submit"
                className="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300 animate-pulse-light"
              >
...
function getSocialIconPath(social) {
  switch (social) {
    case 'facebook':
